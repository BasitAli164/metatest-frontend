...
function App() {
  ...
  const totalTests =
    analyticsData?.overall?.reduce((acc, curr) => acc + curr.totalTests, 0) ||
    0;
  const totalViolations =
    analyticsData?.overall?.reduce(
      (acc, curr) => acc + curr.totalViolations,
      0,
    ) || 0;
  const avgReliability =
    analyticsData?.overall?.length > 0
      ? Math.round(
          analyticsData.overall.reduce(
            (acc, curr) => acc + curr.reliabilityScore,
            0,
          ) / analyticsData.overall.length,
        )
      : 0;
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 hidden sm:block">
                  AI Metamorphic Testing Platform
                </p>
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3 ml-4">
                <a
                  href="https://github.com/BasitAli164"
                  className="text-gray-400 hover:text-primary-400 transition-colors"
                >
                  <Github className="w-5 h-5" />
                </a>
                <a
                  href="https://huggingface.co/BasitAliii"
                  className="text-gray-400 hover:text-primary-400 transition-colors"
                >
        ...
        <footer className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-500 max-w-2xl">
              MetaTest-MERN is a research platform for metamorphic testing of AI
              models, designed to detect bias, inconsistency, and reliability
              issues in natural language processing systems. Built with React,
              Node.js, MongoDB, and Hugging Face Inference API.
            </p>

            {/* Copyright BELOW description */}
            <p className="text-sm text-gray-500 mt-4">
              © 2026 MetaTest-MERN. Research-grade AI testing platform
            </p>
          </div>
        </footer>
      </main>
