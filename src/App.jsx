          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center mt-4 md:mt-0">
              <p className="text-sm text-gray-500 max-w-2xl text-center">
                MetaTest-MERN is a research platform for metamorphic testing of
                AI models, designed to detect bias, inconsistency, and
                reliability issues in natural language processing systems. Built
                with React, Node.js, MongoDB, and Hugging Face Inference API.
              </p>
            </div>
          </div>
        </footer>
